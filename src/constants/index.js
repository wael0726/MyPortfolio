...
export const workExperiences = [
  {
    ...
    title: "Developing and managing a personal website to offer web development services. The website serves as a platform where clients can reach out to request custom web development projects tailored to their needs.",
    icon: '/assets/profileimgwhite.png',
    animation: 'victory',
  },
  {
    id: 2,
    name: 'Internship - LesZheureux',
    pos: 'Web Developer',
    duration: '2025',
    title: "Designed and developed a showcase website for a company specializing in childcare services. Created a responsive interface to present services, schedules, and activities, with SEO optimization and intuitive navigation.",
    icon: '/assets/LesZheureux.png',
    animation: 'clapping',
  },
];
